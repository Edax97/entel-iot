                ...
                <tr>
                  ...
                  <td style={{ paddingLeft: "10px", paddingRight: "10px" }}>
                    <div className="input-group mb-0">
                      ...
                      >
                        <option selected>Seleccione...</option>
                        <option value="CAMARA 1 MP">
                          Promedio CAMARA 1 MP
                        </option>
                        <option value="CAMARA 3 MP">
                          Promedio CAMARA 3 MP
                        </option>
                        <option value="CAMARA 4 MP">
                          Promedio CAMARA 4 MP
                        </option>
                        <option value="CAMARA 5 MP">
                          Promedio CAMARA 5 MP
                        </option>
                        <option value="CAMARA 6 MP">
                          Promedio CAMARA 6 MP
                        </option>
                        <option value="CAMARA 1 PT">
                          Promedio CAMARA 1 PT
                        </option>
                        <option value="CAMARA 2 PT">
                          Promedio CAMARA 2 PT
                        </option>
                        <option value="CAMARA 3 PT">
                          Promedio CAMARA 3 PT
                        </option>
