    ...
    <div className="header" style={{backgroundColor: "rgb(31, 30, 119)", height:"50px"}}>
      ...
      <div className="container p-4">        
          <div className="container-fluid p-0">
            <div className="mb-3">
              <h1 className="h3 d-inline align-middle" style={{fontSize: "14px"}}>Configuracion</h1>						
            </div>
            <div className="row">
              <div className="col-12 col-lg-6 mb-3">
                <div className="card">
                  <div className="card-header" style={{background: "#242a30"}}>
                    <h5 className="card-title mb-0 font-weight-bold text-white">Registro de Configuracion</h5>
                  </div>
                  <div className="card-body pb-2">
                    <input type="text" className="form-control" placeholder="Ingrese nombre" style={{fontSize: "12px"}} />
                  </div>
                  <div className="card-body pb-1">
                    <input type="email" className="form-control" placeholder="Ingrese email" style={{fontSize: "12px"}} />
                  </div>
                  <div className="card-body">
                    <button type="button" className="btn btn-primary" data-original-title="" title="" style={{fontSize: "13px"}}>
                      Enviar
                    </button>
                  </div>
                </div>
              ...
              <div className="col-12 col-lg-6">
                <div className="card" style={{height: "207px"}}>
                  <div className="card-header" style={{background: "rgb(36, 42, 48)"}}>
                    <h5 className="card-title mb-0 font-weight-bold text-white">Registro correo</h5>
                  </div>
                  <div className="card-body">
                          ...
                          <tbody className="text-body-config">
                              <tr>
                                  ...
                                  <td className="td-actions text-right">                                
                                      <button type="button" rel="tooltip" className="btn btn-primary" data-original-title="" title="" style={{fontSize: "13px"}}>
          ...
          <div className="card shadow mb-4">
              <div className="card-header py-3" style={{background: "#242a30"}}>              
                <h6 className="m-0 font-weight-bold text-white">Configurar dispositivos registrados</h6>
              </div>              
              <div className="card shadow mb-4"> 
          ...
          <div className="card shadow mb-4">
            <div className="card-header py-3" style={{background: "#242a30"}}>
              <h6 className="m-0 font-weight-bold text-white">Configurar areas registradas</h6>
            </div>
            <div className="card-body">
              <div className="table-responsive">
